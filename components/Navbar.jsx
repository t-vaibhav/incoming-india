...
export default function Navbar() {
    ...
    return (
        <nav className={`h-24 ${color ? 'bg-black h-[60px]' : 'bg-transparent'} duration-300 ease-in-out fixed top-0 left-0 right-0 z-50 px-10 flex w-full items-center justify-between text-gray-200 hover:text-white`}>
            <div className=''>
