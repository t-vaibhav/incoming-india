            ...
            <div className='h-[40vh] md:h-[50vh] flex py-2'>
                ...
                >
                    ...
                    <SwiperSlide className="relative">
                        <img src="/media/bhutan/eastern/01.webp" alt="taj" className="object-cover" />
                    </SwiperSlide>


                    <SwiperSlide className="relative">
                        <img src="/media/bhutan/eastern/02.webp" alt="taj" className="object-cover" />
                    </SwiperSlide>


                    <SwiperSlide className="relative">
                        <img src="/media/bhutan/eastern/03.webp" alt="taj" className="object-cover " />
                    </SwiperSlide>


                    <SwiperSlide className="relative">
                        <img src="/media/bhutan/eastern/04.webp" alt="taj" className="object-cover" />
                    </SwiperSlide>
