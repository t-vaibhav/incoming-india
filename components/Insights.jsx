...
export default function Insights() {
  return (
    <div>
      <div
        className="w-screen h-[580px] lg:h-[620px] flex justify-center"
        id="insights"
      >
      ...
      <div id="insight-section">
        ...
        <div className="flex flex-col lg:flex-row mb-8 font-lora" id='1'>
        ...
        <div className="flex flex-col lg:flex-row mb-8 font-lora" id='3'>
          <div className="w-full lg:w-1/2">
            <Image
              src={Protection}
              alt="Your Image"
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center my-4">
            <div>
              <h1 className="text-center text-4xl mt-2 mb-6 text-white underline decoration-orange-500 underline-offset-8">PROTECTION</h1>
        ...
        <div className="flex flex-col-reverse lg:flex-row mb-8 font-lora" id='4'>
          <div className="w-full lg:w-1/2 flex items-center justify-center my-4 mb-6">
            <div>
              <h1 className="text-center text-4xl mt-2 mb-6 text-white underline decoration-orange-500 underline-offset-8">COMMUNICATION</h1>
        ...
        <div className="flex flex-col lg:flex-row mb-8 font-lora" id='5'>
          <div className="w-full lg:w-1/2">
            <Image
              src={Transit}
              alt="Your Image"
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center my-4">
            <div>
              <h1 className="text-center text-4xl mt-2 mb-6 text-white underline decoration-orange-500 underline-offset-8">TRANSIT</h1>
        ...
        <div className="flex flex-col-reverse lg:flex-row mb-8 font-lora" id='6'>
          <div className="w-full lg:w-1/2 flex items-center justify-center my-4 mb-6">
            <div>
              <h1 className="text-center text-4xl mt-2 mb-6 text-white underline decoration-orange-500 underline-offset-8">RECREATION</h1>
        ...
        <div className="flex flex-col lg:flex-row mb-8 font-lora" id='7'>
          <div className="w-full lg:w-1/2">
            <Image
              src={Cuisine}
              alt="Your Image"
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center my-4">
            <div>
              <h1 className="text-center text-4xl mt-2 mb-6 text-white underline decoration-orange-500 underline-offset-8">CUISINE</h1>
