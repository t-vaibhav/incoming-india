...
export default function Hero() {
    ...
    return (
        <section className='relative '>
            ...
            <div className='bg-black/10 absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center text-white text-center'>
                <div className=' max-w-[600px] space-y-4'>
                    <h1 className='text-5xl font-bold font-EBG tracking-widhero-shadow'>INCOMING INDIA</h1>
                    <p className='text-xl font-serifjp hero-shadow'>Discover The Magic Of India With Incoming India - Your Ultimate Travel Partner!</p>
                </div>
            </div>
