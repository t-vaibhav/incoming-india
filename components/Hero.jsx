        ...
        <section className='relative '>
            <div>
                <video autoPlay muted loop id="myVideo" className='h-[100vh] w-[100vw] object-cover opacity-100  top-0 -z-50 relative' >
                    <source src="/media/india22.mp4" type="video/mp4" />
            ...
            <div className='bg-black/50 px-2 absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center text-white text-center'>
                <div className=' max-w-[1200px] space-y-4'>
                    ...
                    <p className='md:text-2xl text-xl  font-poppins hero-shadow'>Discover The Magic Of India With Your Ultimate Travel Partner!</p>
                </div>
            </div>
